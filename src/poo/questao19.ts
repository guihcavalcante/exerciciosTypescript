// Repetição Encapsulamento Arrays
// Monitoramento de Sensores Industriais
// Uma fábrica instalou sensores para monitorar sua produção. Todo sensor possui um código identificador e a última leitura registrada. Um Sensor de Temperatura exibe sua leitura acompanhada da unidade "°C" e possui um alerta caso passe dos 40°C. Um Sensor de Pressão exibe sua leitura acompanhada de "atm" e alerta se passar de 5 atm. O programa deve solicitar repetidamente que o técnico digite os valores lidos pelos sensores espalhados pela fábrica, armazenando-os em um array. No final, o programa filtra a lista e exibe o relatório de todos os sensores que dispararam alertas de perigo.[cite: 1]
