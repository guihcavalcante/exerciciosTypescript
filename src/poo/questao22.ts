...
// O setor de transportes públicos precisa mapear a manutenção de seus veículos. Crie uma classe base para Veículo com placa e quilometragem atual. Os Ônibus precisam fazer revisão a cada 10.000 km, enquanto as Ambulâncias precisam de revisão preventiva a cada 5.000 km. O sistema interativo deve perguntar as informações da frota atual e guardar os objetos em um array. Depois, o programa solicita que o mecânico informe a quilometragem atual de um determinado veículo e, varrendo o array de objetos, o sistema responde textualmente se aquele veículo específico precisa ou não ser retido para manutenção imediata.[cite: 1]
