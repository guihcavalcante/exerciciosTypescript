...
// Uma cooperativa de crédito local precisa de um protótipo para gerenciar contas de clientes. A conta deve ter o nome do titular e o saldo protegido, acessível apenas por métodos de depósito e saque. Existem dois tipos de contas: a Conta Corrente (que cobra uma taxa de R$ 2,00 a cada saque) e a Conta Poupança (que possui um método de rendimento que acrescenta 1% ao saldo atual). O programa deve interagir com o usuário perguntando qual conta ele deseja movimentar, solicitando valores para depósito e saque através de um menu repetitivo até que ele decida sair, exibindo o saldo atualizado de forma protegida após cada operação.[cite: 1]
